...
<h3 align="center">Specter</h3>
  ...
  <p align="center">
    Specter is core client and scripting engine. Provides the low-level API for connecting to and communicating with Specter-instrumented Qt applications over gRPC. Enables scripting, test automation, and programmatic interaction.
    </br>
    </br>
...
- [ ] Interface for scripting test automation
- [ ] Mapper for translation recorded actions into script
